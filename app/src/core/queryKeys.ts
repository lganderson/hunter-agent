...
export function normalizeCandidateListFilters(
  ...
  return {
    ...
    industries: normalizeValues(filters.industries, value => value.trim()),
    sizes: normalizeValues(filters.sizes, value => value.trim()),
    sources: normalizeValues(filters.sources, value => value.trim()),
    ...
    reviewableOnly: filters.reviewableOnly === true,
