...
from .discovery_queries import (
    WORK_MODE_CODES, ALL_WORK_MODES, ROLE_QUERY_FAMILIES, ROLE_QUERY_FAMILIES_BY_ID, search_keyword_families, expanded_search_keywords, linkedin_search_url, work_mode_query, location_query, recent_query, discovery_query, normalized_location_text
)
...
def upsert_search(search_id="", updates=None):
    ...
    repository.save_discovery_searches_changes(rows)
...
def run_search(
    ...
    if stored is not None:
        ...
        repository.save_discovery_searches_changes(stored_rows)
